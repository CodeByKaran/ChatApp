...
export default function ChatHeader({ roomId, onMenuToggle }: ChatHeaderProps) {
  ...
  return (
    <header className="flex items-center justify-between bg-card border-b border-border px-4 py-3 sticky top-0 z-40">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="bg-background backdrop-blur-lg">
