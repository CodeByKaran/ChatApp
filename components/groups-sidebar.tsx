...
export default function GroupsSidebar() {
  ...
  const fetchRooms = async () => {
    try {
      // Use getUser() instead of getSession() for better security/reliability
      const {
        data: { user },
  ...
  return (
    <aside className="  flex-col w-72 bg-card border-r border-border h-screen sticky top-0 p-4 gap-4 overflow-hidden">
      {/* Header */}
      <div>
        ...
        <div className="flex gap-2">
          <AlertDialogComp ButtonText="Create">
            <AlertDialogHeader>
              <AlertDialogTitle>Create New Group</AlertDialogTitle>
              <AlertDialogDescription>
                Enter a name for your new chat group. You can share the group ID
                with friends to let them join.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <Input placeholder="Group Name" ref={inputRef} className="mt-2" />
            <AlertDialogFooter>
          ...
          <AlertDialogComp ButtonText="Join">
            <AlertDialogHeader>
            ...
            <Input placeholder="Group ID" ref={inputRef} className="mt-2" />
            <AlertDialogFooter>
              <AlertDialogCancel>Cancel</AlertDialogCancel>
              <AlertDialogAction
